...
echo -e  " \e[$text Version Script       : New-Multiport (V3)"            
...
echo -e   " \e[$line└─────────────────────────────────────────────────┘\e[m"
echo -e   " \e[$line┌─────────────────────────────────────────────────┐\e[m"
echo -e   "  \e[$number [�1]\e[m \e[$below Openssh & Openvpn\e[m       \e[$number [�6]\e[m \e[$below Menu Tema\e[m"
echo -e   "  \e[$number [�2]\e[m \e[$below Xray Vmess & Vless\e[m      \e[$number [�7]\e[m \e[$below Clear Log Vps\e[m"
echo -e   "  \e[$number [�3]\e[m \e[$below Trojan Xray & Ws\e[m        \e[$number [�8]\e[m \e[$below Tukar Port \e[m"
echo -e   "  \e[$number [�4]\e[m \e[$below Sistem Menu\e[m             \e[$number [�9]\e[m \e[$below Check Service \e[m"
echo -e   "  \e[$number [�5]\e[m \e[$below Info Semua Port\e[m         \e[$number [�10]\e[m\e[$below REBOOT Vps\e[m"
echo -e   " \e[$line└─────────────────────────────────────────────────┘\e[m"m"
echo -e   ""
